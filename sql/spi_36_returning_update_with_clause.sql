...
DO $body$ DECLARE ok boolean := false; BEGIN
    FOR i IN 1..15 LOOP
        ...
        PERFORM pg_sleep(1);
    END LOOP;
    IF NOT ok THEN RAISE EXCEPTION 'timed out after 15 x pg_sleep(1) waiting for task group ''returning_update_with_clause'' to finish (leave PLAN/TAKE/WORK)'; END IF;
