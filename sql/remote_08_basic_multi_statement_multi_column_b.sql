...
DO $body$ DECLARE ok boolean := false; BEGIN
    ...
    END LOOP;
    IF NOT ok THEN RAISE EXCEPTION 'timed out after 300 x pg_sleep(0.1) waiting for task group ''basic_multi_stmt_multi_col_b'' to finish (leave PLAN/TAKE/WORK)'; END IF;
