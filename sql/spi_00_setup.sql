...
DO $body$ DECLARE ok boolean := false; BEGIN
    FOR i IN 1..120 LOOP
        ...
        PERFORM pg_sleep(1);
    END LOOP;
    IF NOT ok THEN RAISE EXCEPTION 'timed out after 120 x pg_sleep(1) waiting for pg_task extension to create public.task and its pg_work worker to become idle'; END IF;
