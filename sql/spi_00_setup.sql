...
DO $body$ DECLARE ok boolean := false; BEGIN
    ...
    END LOOP;
    IF NOT ok THEN RAISE EXCEPTION 'timed out after 1200 x pg_sleep(0.1) waiting for pg_task extension to create public.task and its pg_work worker to become idle'; END IF;
