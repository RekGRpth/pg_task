...
DO $body$ DECLARE ok boolean := false; BEGIN
    ...
    END LOOP;
    IF NOT ok THEN RAISE EXCEPTION 'timed out after 300 x pg_sleep(0.1) waiting for at least 3 DONE runs in repeating task group ''role_owner_preserved_repeat'''; END IF;
