...
void _PG_init(void) {
    ...
    DefineCustomIntVariable("pg_task.default_fetch", "pg_task default fetch", "fetch at once", &task_default_fetch, 100, 1, INT_MAX, PGC_SIGHUP, 0, NULL, NULL, NULL);
    ...
    DefineCustomIntVariable("pg_work.default_sleep", "pg_work default sleep", "sleep before load", &work_default_sleep, 10, 1, INT_MAX, PGC_SIGHUP, 0, NULL, NULL, NULL);
