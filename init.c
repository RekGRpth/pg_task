...
void _PG_init(void) {
    ...
    DefineCustomIntVariable("pg_task.max", "pg_task default max", "maximum parallel tasks", &task_max, 0, INT_MIN, INT_MAX, PGC_USERSET, 0, NULL, NULL, NULL);
    ...
    DefineCustomIntVariable("pg_work.timeout", "pg_work default timeout", "check tasks every timeout milliseconds", &work_timeout, 1000, 1, INT_MAX, PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_task.active", "pg_task default active", "task active after plan time", &task_active, "1 hour", PGC_USERSET, 0, NULL, NULL, NULL);
    ...
    DefineCustomStringVariable("pg_task.delimiter", "pg_task default delimiter", "results colums delimiter", &task_delimiter, "\t", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_task.escape", "pg_task default escape", "results colums escape", &task_escape, "", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_task.group", "pg_task default group", "group tasks name", &task_group, "group", PGC_USERSET, 0, NULL, NULL, NULL);
    ...
    DefineCustomStringVariable("pg_task.live", "pg_task default live", "exit until timeout", &task_live, "0 sec", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_task.null", "pg_task default null", "text null representation", &task_null, "\\N", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_task.quote", "pg_task default quote", "results colums quote", &task_quote, "", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_task.repeat", "pg_task default repeat", "repeat task", &task_repeat, "0 sec", PGC_USERSET, 0, NULL, NULL, NULL);
    ...
    DefineCustomStringVariable("pg_task.timeout", "pg_task default timeout", "task timeout", &task_timeout, "0 sec", PGC_USERSET, 0, NULL, NULL, NULL);
    ...
    DefineCustomStringVariable("pg_work.active", "pg_work default active", "task active before now", &work_active, "1 week", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_work.data", "pg_work default data", "default database name", &work_data, "postgres", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_work.reset", "pg_work default reset", "reset tasks every interval", &work_reset, "1 hour", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_work.schema", "pg_work default schema", "schema name for tasks table", &work_schema, "public", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_work.table", "pg_work default table", "table name for tasks table", &work_table, "task", PGC_USERSET, 0, NULL, NULL, NULL);
    DefineCustomStringVariable("pg_work.user", "pg_work default user", "default username", &work_user, "postgres", PGC_USERSET, 0, NULL, NULL, NULL);
