...
| plan | timestamp with time zone | NOT NULL | CURRENT_TIMESTAMP | planned date and time of start |
| start | timestamp with time zone | NULL | | actual time of start |
| stop | timestamp with time zone | NULL | | actual time of stop |
...
| count | integer | NOT NULL | pg_task.count | non-negative maximum tasks, executed by current worker |
| hash | integer | NOT NULL | generated by group and remote | hash for identifying group task |
