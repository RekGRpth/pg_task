...
- `run` - максимальное число одновременно выполняемых рабочим задач (по-умолчанию это 2147483647)
...
| pg_task.run | int | 2147483647 | конфигурация, база, пользователь, сессия | максимальное число одновременно выполняемых рабочим задач |
