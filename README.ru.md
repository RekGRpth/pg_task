...
Физически планировщик состоит из четырёх основных частей:
...
3) pg_work - фоновый рабочий процесс, который периодически опрашивает таблицу с заданиями и при наличии задач, запускает их выполнение в удалённой базе или запускает фоновый рабочий процесс pg_task для выполнения задачи в локальной базе
